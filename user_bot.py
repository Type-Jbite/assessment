...
# ID чата, куда будут отправляться уведомления (ваш админ-чат)
ADMIN_CHAT_ID = "-1002729661400"  # ✅ НОВЫЙ ID ЧАТА

# === ГЛОБАЛЬНЫЕ ПЕРЕМЕННЫЕ ===
user_data = {}           # Инициализация словаря
location_attempts = {}   # Инициализация

# === ИМПОРТ ИЗ SHARED.PY (только геолокация) ===
from shared import (
